...
<section id="feature_news_section" class="feature_news_section">
    <div class="container">
        <div class="row">
            <div class="col-md-7">
                <div class="feature_article_wrapper">
                    ...
                    <div class="feature_article_inner">
                        ...
                        <div class="feature_article_date"><a href="{{ url('/details') }}/{{ $hot_news->slug }}}" >{{$hot_news->creator->name}}</a>,<a href="#"
                        ...
                        <div class="article_social">
                            ...
                            <span><i class="fa fa-comments-o"></i><a href="#">{{ count($hot_news->comments) }}</a>Comments</span>
                        </div>
                        <!-- article_social -->
            ...
            <!-- col-md-7 -->
@foreach($top_viwed as $top)
            <div class="col-md-5" style="margin-bottom:3%">
                <div class="feature_static_wrapper">
                    <div class="feature_article_img">
                        <img class="img-responsive" width="450" style="height:270px !important;" src="{{ asset('post') }}/{{ $top->main_image  }}" alt="feature-top">
                    </div>
                    <!-- feature_article_img -->
                    ...
                    <div class="feature_article_inner">
                        ...
                        <div class="feature_article_title">
                            <h1><a href="{{ url('/details') }}/{{ $hot_news->slug }}}" target="_self">{{($top->title)}}</a></h1>
                        </div>
                        <!-- feature_article_title -->

                        <div class="feature_article_date"><a href="#" target="_self">{{$top->creator->name}}</a>,<a href="#"
                                                                                                         target="_self">{{ date('j F -y',strtotime($top->created_at)) }}</a></div>
                        <!-- feature_article_date -->

                        <div class="feature_article_content">
                            {{str_limit($top->short_description,50,'...')}}
                        </div>
                        <!-- feature_article_content -->

                        <div class="article_social">
                            <span><i class="fa fa-share-alt"></i><a href="#">424</a>Shares</span>
                            <span><i class="fa fa-comments-o"></i><a href="#">{{ count($top->comments) }}</a>Comments</span>
                        </div>
                        <!-- article_social -->
...
<div class="widget">
    <div class="widget_title widget_black">
        <h2><a href="#">Most Views News</a></h2>
    </div>
